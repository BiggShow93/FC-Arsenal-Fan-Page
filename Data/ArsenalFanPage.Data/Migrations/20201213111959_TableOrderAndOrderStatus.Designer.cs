...
namespace ArsenalFanPage.Data.Migrations
{
    ...
    [Migration("20201213111959_TableOrderAndOrderStatus")]
    partial class TableOrderAndOrderStatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArsenalFanPage.Data.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("ArsenalFanPage.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ArsenalFanPage.Data.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ArsenalFanPage.Data.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ArsenalFanPage.Data.Models.ProductCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ArsenalFanPage.Data.Models.Comment", b =>
                {
                    ...
                    b.HasOne("ArsenalFanPage.Data.Models.Comment", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("ArsenalFanPage.Data.Models.Order", b =>
                {
                    b.HasOne("ArsenalFanPage.Data.Models.ApplicationUser", "AddedByUser")
                        .WithMany("Orders")
                    ...
                    b.HasOne("ArsenalFanPage.Data.Models.OrderStatus", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("ArsenalFanPage.Data.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ArsenalFanPage.Data.Models.ApplicationUser", null)
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
